...
void BiblAudio::readSoundFic(const std::string &pathToFic,const Ice::Current& curIce)
{
    ...
    std::string token = ipCoInfo->remoteAddress.substr(7) + "." + "10000"/*std::to_string(ipCoInfo->remotePort)*/ + "." + "100000"/*std::to_string(std::chrono::duration_cast<std::chrono::nanoseconds>(duration).count())*/;
